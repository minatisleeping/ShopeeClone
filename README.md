...
_Giao diện trang chủ với danh sách sản phẩm, filter sidebar, và hệ thống phân trang_

### 🔐 Đăng nhập - Login

![Login](./image/login.png)
_Trang đăng nhập với form validation và responsive design_

### 📝 Đăng ký - Register

![Register](./image/register.png)  
_Trang đăng ký tài khoản với validation schema_
...
_Dự án này showcase best practices trong việc xây dựng ứng dụng React enterprise-level với focus vào performance, security, và exceptional user experience._# 🛒 Shopee Clone Advanced
