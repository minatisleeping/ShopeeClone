...
function AsideFilter() {
  return (
    <div className='py-4'>
      <Link to={path.home} className='flex items-center font-normal capitalize cursor-default'>
      ...
      <ul>
        <li className='py-2 pl-2'>
          <Link to={path.home} className='relative px-2 text-orange font-semibold capitalize'>
            <svg viewBox='0 0 4 7' className='fill-orange h-2 w-2 absolute top-1.5 left-[-10px] '>
        ...
        <li className='py-2 pl-2'>
          <Link to={path.home} className='relative px-2 capitalize'>
            Điện thoại
          </Link>
        </li>
      </ul>
      ...
      <div className='my-5'>
        ...
        <form className='mt-2'>
          <div className='flex items-start'>
            ...
            />
            <div className='mx-2 mt-[5px] shrink-0 text-gray-400'>-</div>
            <Input
              type='text'
              className='grow'
              name='from'
